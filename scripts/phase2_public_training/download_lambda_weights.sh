...
#   LAMBDA_HOST=ubuntu@150.136.111.175 PEM=~/.ssh/key.pem bash scripts/phase2_public_training/download_lambda_weights.sh
...
HOST="${LAMBDA_HOST:-ubuntu@150.136.111.175}"
